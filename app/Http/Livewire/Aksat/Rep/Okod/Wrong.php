...
class Wrong extends Component
{
  ...
  public function Date1Chk()
  {
    ...
    {
        return view('livewire.aksat.rep.okod.wrong',[
          'RepTable'=>DB::connection(Auth()->user()->company)->table('wrong_view')
            ->whereBetween('tar_date',[$this->wrong_date1,$this->wrong_date2])
