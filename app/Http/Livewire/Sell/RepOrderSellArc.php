...
class RepOrderSellArc extends Component
{
  use WithPagination;
  ...
  public function ChkOrderNoAndGo(){
    if ($this->order_no) {
      ...
      $res=Arc_Sells::where('order_no',$this->order_no)->first();
    ...
    if ($res) {
      ...
      $this->jeha_name=Arc_Jeha::on(Auth()->user()->company)->where('jeha_no',$this->jeha_no)->first()->jeha_name;
  ...
  public function render()
    {
      ...
      return view('livewire.sell.rep-order-sell-arc',[
        'orderdetail'=>Arc_rep_sell_tran::where('order_no',$this->orderno2)->paginate(15)
      ]);
    }
}
