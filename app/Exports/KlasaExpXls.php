...
class KlasaExpXls implements FromCollection, WithHeadings, WithEvents,WithColumnWidths,WithColumnFormatting, WithTitle,WithStyles
{
    /**
  ...
  public function map($TransTableExp): array
  {
    return [
      $TransTableExp->who_name,
      $TransTableExp->type_name,
      $TransTableExp->val,
  ...
  public function registerEvents(): array
  {
    return [
      ...
      AfterSheet::class => function(AfterSheet $event)  {
        ...
        $event->sheet->setCellValue('A6', 'خلاصة إيصالات الدفع من  '.$this->date1.' إلي '.$this->date2);
  ...
  public function collection()
  {
    ...
    $tot=DB::connection(Auth()->user()->company)->table('trans')
      ...
      ->first();
    $this->val=$tot->val;
    $this->rowcount=$TransTableExp->count();
    return $TransTableExp;
  }
}
