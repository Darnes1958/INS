      ...
      @foreach($ChargeDetail as $key => $item)
        ...
        <tr>
          ...
          <td style="padding-top: 2px;padding-bottom: 2px; ">
            <i wire:click.prevent="edititem({{$item->rec_no}})" class="btn btn-outline-primary btn-sm fa fa-edit editable-input" style="margin-left: 2px;"></i></td>
          <td>
            <i  wire:click.prevent="removeitem({{$item->rec_no}})" class="btn btn-outline-danger btn-sm fa fa-times "></i>
          </td>
        </tr>
      @endforeach
      </tbody>
