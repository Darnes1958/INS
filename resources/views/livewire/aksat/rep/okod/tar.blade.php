<div>
  <div  x-data >
   <div    class="row gy-1 my-1" style="border:1px solid lightgray;background: white; " >
    ...
    <a  href="{{route('pdftar',['bank_no'=>$bank_no,'tar_date1'=>$tar_date1,'tar_date2'=>$tar_date2,'bank_name'=>$bank_name,'tar_type'=>$tar_type])}}"
  ...
  <div class="row" >
    <div class="col-md-3">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" wire:model="tar_type"   value="1">
        <label class="form-check-label" >من الفائض</label>
      </div>
      <div class="form-check form-check-inline ">
        <input class="form-check-input" type="radio" wire:model="tar_type"   value="2">
        <label class="form-check-label" >من الخطأ</label>
      </div>
    </div>
  </div>
