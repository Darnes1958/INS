  ...
  <div class="row">
    <div class="col-md-6">
      <table class="table table-sm table-bordered table-striped table-light " width="100%"  id="mytable3" >
        <caption class="caption-top text-center text-warning" >العقود القائمة</caption>
    ...
    <div class="col-md-6" x-show="$wire.TajNo ">
      <table class="table table-sm table-bordered table-striped table-light " width="100%"  id="mytable3" >
       <caption class="caption-top text-center text-success" >غير موجودة لدينا</caption>
        <thead class="font-size-12">
        <tr>
    ...
    <div class="col-md-6" x-show="$wire.TajNo ">
      <table class="table table-sm table-bordered table-striped table-light " width="100%"  id="mytable3" >
        <caption class="caption-top text-center text-success" >غير موجودة لدي المصرف</caption>
        <thead class="font-size-12">
        <tr>
