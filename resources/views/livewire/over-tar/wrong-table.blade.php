    ...
    @foreach($TableList as  $item)
      <tr class="font-size-12">
        ...
        <td  style="padding-top: 2px;padding-bottom: 2px; ">
          <i wire:click="selectItem({{ $item->wrong_no }},'update')"
             class="btn btn-outline-primary btn-sm fa fa-edit editable-input" style="margin-left: 2px;"></i>
        </td>
        <td  style="padding-top: 2px;padding-bottom: 2px; ">
          <i wire:click="selectItem({{ $item->wrong_no }},'delete')"
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h1 class="modal-title fs-5 mx-6" id="exampleModalLabel">تعديل قسط وارد بالخطأ</h1>
        </div>
        <div class="modal-body">
          @livewire('over-tar.edit-wrong')
        </div>
      </div>
    </div>
  </div>
